...
if (($_SERVER['REQUEST_METHOD'] === 'POST') && isset($_POST['submit'])) {
    ...
    if (empty($msg)) {
        if (createPost($con, $upload_dir, $files, $title, $date, $subtitle, $body) === TRUE) {
            $successmsg = '<div class="adm-alert adm-alert--success">Post created</div>
            <a href="' . URL . '/posts" class="adm-btn adm-btn--ghost">View Post</a>';
        } else {
            $msg[] = '<div class="adm-alert adm-alert--error">Failed to create post</div>';
        }
    }
}
?>
...
<section class="admin-section adm-section">
    <div class="adm-pagehead" data-aos="fade-up">
        <div>
            ...
            <h1 class="adm-pagehead__title">Create a <em>post</em></h1>
        </div>
        <a href="./posts" class="adm-btn adm-btn--ghost"><i class="fa fa-arrow-left"></i> Back to post list</a>
    </div>
    ...
    <div class="adm-formgrid" data-aos="fade-up">
        <aside class="adm-formgrid__aside">
            ...
            <ul class="adm-bullets">
                <li>Use a descriptive title (e.g. "Archmate property event in Ogwashi-ukwu").</li>
                <li>Media must contain first an image and then maybe videos</li>
        ...
        <div class="reg-container2 adm-formcard">
            ...
            <form action="" method="POST" enctype="multipart/form-data" class="adm-form">
                <label class="adm-field">
                    <span>Title</span>
                    <span class="input-container"><input type="text" name="title" placeholder="E.g An Archmate Event"></span>
                </label>
                <label class="adm-field">
                    <span>Subtitle</span>
                    <span class="input-container"><input type="text" name="subtitle" placeholder="E.g Give a brief description"></span>
                </label>
