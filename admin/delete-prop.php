...
include_once "includes/count.inc.php";
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if(isset($_POST['submit']) && $_POST['submit'] == 'delete'){
            $q6 = "DELETE FROM properties WHERE id = ?";
...
<section class="admin-section">
    <div class="adm-confirm adm-confirm--danger">
        <header class="adm-confirm__head">
            ...
            <h1 class="adm-confirm__title">Delete Property Listing</h1>
            <p class="adm-confirm__lead">Removing this listing will detach it from the public site immediately. Saved searches and inbound enquiries linked to it will no longer resolve.</p>
        </header>
        ...
        <div class="adm-confirm__body">
            ...
            <div class="adm-confirm__target">
                ...
                <div>
                    <span class="adm-confirm__label">Property</span>
                    <h3 class="adm-confirm__name"><?php echo isset($row['title']) ? htmlspecialchars($row['title']) : 'Untitled listing'; ?></h3>
                    <p class="adm-confirm__sub">ID #<?php echo (int)$id; ?></p>
                </div>
            </div>

            <ul class="adm-confirm__bullets">
                <li><i class="fa-solid fa-circle-exclamation"></i> Listing will be removed from the database.</li>
