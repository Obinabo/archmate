...
include_once "includes/count.inc.php";
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        if(isset($_POST['submit']) && $_POST['submit'] == 'delete'){
            $q6 = "DELETE FROM contact WHERE id = ?";
...
<section class="admin-section">
    <div class="adm-confirm adm-confirm--danger">
        <header class="adm-confirm__head">
            ...
            <h1 class="adm-confirm__title">Delete Selected Contact</h1>
            <p class="adm-confirm__lead">Clicking on DELETE will automatically remove this contact from the database. </p>
        </header>
        ...
        <div class="adm-confirm__body">
            ...
            <div class="adm-confirm__target">
                ...
                <div>
                    <span class="adm-confirm__label">Contact</span>
